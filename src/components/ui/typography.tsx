...
const typographyVariants = cva('', {
  variants: {
    variant: {
      h1: 'scroll-m-20 font-serif text-4xl font-extrabold tracking-tight text-balance',
      h2: 'scroll-m-20 font-serif pb-2 text-3xl font-semibold tracking-tight first:mt-0',
      ...
      h6: 'scroll-m-20 font-serif text-lg font-semibold tracking-tight',
